...
export async function POST(
  ...
  try {
    ...
    console.error("POST /api/associate/user-details/[id] error", error);
    return NextResponse.json(
...
export async function GET(
  ...
  try {
    ...
    const data = details.map((d) => {
      ...
      return { ...(rest as object), extra } as unknown;
    });
    ...
    console.error("GET /api/associate/user-details/[id] error", error);
    return NextResponse.json(
